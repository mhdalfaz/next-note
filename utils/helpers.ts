...
export const getCurrentDate = (format: ParamDateFormat = "yyyy-mm-dd"): string => {
...
export const changeFormatDate = (date?: string, format: ParamDateFormat = "yyyy-mm-dd"): string => {
